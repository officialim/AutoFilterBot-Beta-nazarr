...
if len(API_HASH) == 0:
    ...
    exit()
BOT_TOKEN = environ.get('BOT_TOKEN', '5986116983:AAF0ZLx6aZFI1i2-sOUaQEorXijRbWubaC8')
if len(BOT_TOKEN) == 0:
...
LOG_CHANNEL = environ.get('LOG_CHANNEL', '-1001572413887')
...
# support group
SUPPORT_GROUP = environ.get('SUPPORT_GROUP', '-1001572413887')
...
# MongoDB information
DATABASE_URL = environ.get('DATABASE_URL', "mongodb+srv://Abcd:abcd1234@cluster0.zsmqgc6.mongodb.net/?retryWrites=true&w=majority")
if len(DATABASE_URL) == 0:
    print('Error - DATABASE_URL is missing, exiting now')
    exit()
DATABASE_NAME = environ.get('DATABASE_NAME', "Abcd")
